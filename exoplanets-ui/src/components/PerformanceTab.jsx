                ...
                <div className="bg-gray-800/50 rounded-2xl border border-gray-700 p-6">
                    ...
                    <div className="space-y-4">
                        <div className="grid grid-cols-2 gap-4">
                            <div className="text-center p-3 bg-gray-800 rounded-lg flex flex-col items-center justify-center">
                                <div className="text-xl font-bold text-indigo-400">{modelInfo.features_used}</div>
                                <div className="text-gray-400 text-sm mt-1">Features Used</div>
                            </div>
                            <div className="text-center p-3 bg-gray-800 rounded-lg flex flex-col items-center justify-center">
                                <div className="text-xl font-bold text-emerald-400">{modelInfo.dataset_size?.toLocaleString()}</div>
                                <div className="text-gray-400 text-sm mt-1">Training Samples</div>
                            </div>
                        </div>
                        <div className="grid grid-cols-2 gap-4">
                            <div className="text-center p-3 bg-gray-800 rounded-lg flex flex-col items-center justify-center">
                                <div className="text-xl font-bold text-cyan-400">{modelInfo.test_set_size?.toLocaleString()}</div>
                                <div className="text-gray-400 text-sm mt-1">Test Samples</div>
                            </div>
                            <div className="text-center p-3 bg-gray-800 rounded-lg flex flex-col items-center justify-center">
                                <div className="text-xl font-bold text-amber-400">{modelInfo.model_type}</div>
                                <div className="text-gray-400 text-sm mt-1">Algorithm</div>
                            </div>
                        </div>
                        {modelInfo.missions && (
                            <div className="text-center p-3 bg-indigo-500/20 rounded-lg border border-indigo-500/30 flex flex-col items-center justify-center">
                                <div className="text-lg font-bold text-purple-400">{modelInfo.missions}</div>
                                <div className="text-gray-400 text-sm mt-1">Trained Missions</div>
                            </div>
                        )}
                        <div className="p-3 bg-gray-800 rounded-lg flex flex-col items-center justify-center">
                            <div className="text-sm text-gray-400">Optimal Threshold</div>
                            <div className="text-white font-semibold mt-1">{performanceMetrics.best_threshold}</div>
                ...
                <div className="bg-gray-800/50 rounded-2xl border border-gray-700 p-6">
                    ...
                    <div className="space-y-4">
                        <div className="grid grid-cols-3 gap-4 text-center">
                            ...
                            <div className="p-3 bg-red-500/20 rounded-lg border border-red-500/30 flex items-center justify-center">
                                <div>
                                    <div className="text-sm text-red-400">False Positive</div>
                                    <div className="text-white mt-1">Non-Exoplanet</div>
                                </div>
                            </div>
                            <div className="p-3 bg-green-500/20 rounded-lg border border-green-500/30 flex items-center justify-center">
                                <div>
                        ...
                        {['precision', 'recall', 'f1_score'].map(metric => (
                            <div key={metric} className="grid grid-cols-3 gap-4 text-center">
                                ...
                                <div className="p-3 bg-gray-700 rounded-lg flex items-center justify-center">
